...
{
	private readonly string DEFAULT_FRAG = @"/resources/shaders/unlitfragment.glsl";

	private readonly string DEFAULT_VERT = @"/resources/shaders/unlitvertex.glsl";

	private ConcurrentDictionary<Guid, Mesh?> meshes = new();
	private ConcurrentDictionary<Guid, Shader?> shaders = new();
	private ConcurrentDictionary<Guid, Texture?> textures = new();
	private ConcurrentDictionary<Guid, Material?> materials = new();
	private ConcurrentDictionary<Guid, Metadata> metadatas = new();

	private GL gl;

	public UserResourceManager(GL gl)
	{
		this.gl = gl;
